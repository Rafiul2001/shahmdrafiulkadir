        ...
        <div id='contact' className='px-3 w-full flex flex-col gap-8 pt-24'>
            <section className='flex flex-col md:flex-row gap-8'>
                ...
                <div className='flex-1'>
                    <form className='w-full sm:px-16 md:px-0 flex flex-col gap-6'>
                        <input className='border-solid border-blue border-2 rounded-md px-3 py-1' type="text" placeholder='Enter your name' />
                        <input className='border-solid border-blue border-2 rounded-md px-3 py-1' type="email" name="" id="" placeholder='Enter your email' />
                        <textarea className='border-solid border-blue border-2 rounded-md resize-none px-3 py-2' name="" id="" cols="30" rows="5" placeholder='Enter your message'></textarea>
